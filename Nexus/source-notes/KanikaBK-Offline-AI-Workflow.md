...
## Core Concepts
- [[concepts/Local-AI-Privacy]] -- keeping sensitive thinking on your own machine
- [[concepts/RAG-Retrieval-Augmented-Generation]] -- answering questions grounded in your own content
- [[concepts/Embedding-Based-Vault-Search]] -- semantic search across your knowledge base
- [[concepts/Local-LLM-API-Compatibility]] -- LM Studio exposes OpenAI-compatible API at localhost
- [[frameworks/Hybrid-AI-Workflow]] -- mixing local and cloud AI based on sensitivity
- [[tools/LM-Studio]] -- local model runner for open-source LLMs
- [[tools/Smart-Connections-Plugin]] -- embedding-based vault search in Obsidian
- [[concepts/On-Device-Knowledge-Base]] -- all processing happens locally, nothing leaves the machine
- [[concepts/Hardware-Reality-of-Local-AI]] -- modern laptops can run 7B-13B models
- [[concepts/Three-Mode-AI-Workflow]] -- deep work, research, and confidential modes

...
- [[frameworks/AI-as-Maintainer]] -- AI as ongoing knowledge steward, not one-off oracle
- [[architectures/Graph-Knowledge-Layer]] -- structured data with wiki-like synthesis on top
- [[frameworks/Compilation-Agent]] -- agent that generates wiki views from structured data

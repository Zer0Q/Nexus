...
- [[frameworks/Compilation-Agent]] -- LLM reads raw sources and writes/maintains wiki pages
...
- [[frameworks/Connection-Cost]] -- Cost model for maintaining knowledge connections
## Key Insights

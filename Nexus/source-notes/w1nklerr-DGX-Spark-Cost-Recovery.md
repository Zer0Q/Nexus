...
## Core Concepts
- [[concepts/DGX-Spark]] -- NVIDIA's desktop AI supercomputer; GB10 Grace Blackwell superchip, $2,999
- [[concepts/DGX-Spark-Specs]] -- 128GB LPDDR5x unified memory, 1 PFLOP FP4, 20-core ARM, 4TB NVMe
- [[concepts/Cloud-GPU-Cost-Recovery]] -- ROI: $1,900/month cloud → ~$10/month local; $22K first-year recovery
- [[concepts/DGX-OS-Stack]] -- NVIDIA's Ubuntu spin with full CUDA stack, same libraries as data-center DGX
- [[concepts/Unified-Memory-Advantage-DGX]] -- 128GB vs 24-32GB consumer GPU; loads 70B-200B models that won't fit elsewhere
- [[concepts/Ollama-Local-Serving]] -- three-command setup: install, pull model, serve at localhost:11434
- [[concepts/Open-WebUI-Local-Chat]] -- Docker container gives ChatGPT-style UI over local models
- [[concepts/Local-AI-Mindset-Shift]] -- from rationing cloud tokens to unlimited local usage; where the real money hides

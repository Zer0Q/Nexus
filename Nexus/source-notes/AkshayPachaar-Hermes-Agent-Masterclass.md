...
## Core Concepts
- [[concepts/Agent-Identity-Layer]] -- SOUL.md as the fixed personality frame
- [[concepts/Agent-Multi-Tier-Memory]] -- three-layer memory: frozen snapshot, session search, external providers
- [[concepts/Self-Evolving-Skills]] -- agent-authored procedural playbooks
- [[concepts/Agent-Skill-Curator]] -- background garbage collection for skills
- [[concepts/GEPA-Prompt-Evolution]] -- offline evolutionary optimization of skills
- [[concepts/Agent-Profiles]] -- fully isolated agent instances per persona
- [[concepts/Agent-Cron-Scheduler]] -- plain English scheduling for recurring tasks
- [[concepts/Progressive-Disclosure-Skills]] -- token-efficient skill loading
- [[concepts/Hermes-Agent-Architecture]] -- unified agent core with platform-agnostic entry points

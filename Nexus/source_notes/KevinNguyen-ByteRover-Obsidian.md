...
## Core Concepts
- [[Federated-Knowledge-Search]] -- search across vault and project code in one query
- [[Read-Only-Vault-Safety]] -- agents read but never modify vault content
- [[Markdown-as-Universal-Format]] -- plain .md files as bridge between tools
- [[Context-Tree-Indexing]] -- structured, indexed knowledge from flat files

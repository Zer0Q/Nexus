...
## Core Concepts
- [[LLM-Wiki-Pattern]] -- persistent wiki as compiled knowledge artifact
- [[Write-Time-Knowledge-Systems]] -- compile once, query many times
- [[Knowledge-Source-of-Truth]] -- raw sources are immutable
- [[Compilation-Agent]] -- LLM as wiki maintainer
- [[Anti-Graveyard-Capture]] -- filed outputs compound knowledge
- [[Browsable-Knowledge]] -- Obsidian as wiki viewer

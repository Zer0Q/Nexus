...
- [[Editorial-Drift]] -- AI summaries lose nuance over time
- [[Error-Compounding]] -- baked-in errors propagate through wiki updates
- [[AI-as-Maintainer]] -- AI as ongoing knowledge steward, not one-off oracle
- [[Graph-Knowledge-Layer]] -- structured data with wiki-like synthesis on top
- [[Compilation-Agent]] -- agent that generates wiki views from structured data

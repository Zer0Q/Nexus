...
## Core Concepts
- [[LLM-Harness]] -- software layer managing context, intermediate steps, and response assembly
- [[Prompt-Validation-Over-Construction]] -- effort shifts from building prompts to validating results
- [[Metaprompt]] -- asking the AI to draft its own optimal prompt for a task
- [[Context-Explosion]] -- harnesses help manage context, but large specs still degrade quality

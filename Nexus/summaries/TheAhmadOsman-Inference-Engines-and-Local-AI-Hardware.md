...
- [[tools/Hardware-First-Engine-Selection]] -- engine follows hardware strategy, not vice versa
- [[tools/Benchmarking-Workload-Shape]] -- proper benchmarking requires full context

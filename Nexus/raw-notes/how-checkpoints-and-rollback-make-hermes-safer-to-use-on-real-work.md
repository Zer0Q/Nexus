...
created: 2026-05-31
description: "Most AI agent demos focus on what the agent can do. Write code. Refactor files. Run shell commands. Modify a project in seconds.That part is..."
tags:
  - "clippings"
---
![Imatge](https://pbs.twimg.com/media/HGGSHflaoAAe0fQ?format=jpg&name=large)
...
- file tool writes via write\_file
- edits via patch
...
> **/rollback 1 src/broken\_file.py**

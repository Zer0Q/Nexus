...
created: 2026-06-02
description: "Codex + one secret tool is the design workflow we've been running at our agency... and the output is genuinely on a different level.I've bee..."
tags:
  - "clippings"
summary:
---
![Imatge](https://pbs.twimg.com/media/HI0qinCbMAAgXgl?format=jpg&name=large)
...
![Imatge](https://pbs.twimg.com/media/HI0nfw_aAAAvq52?format=jpg&name=large)

Moonchild on the left designing the UI. Codex on the right turning it into a working mobile app.

# What Moonchild Actually Is
...
![Imatge](https://pbs.twimg.com/media/HI0n5VJaoAAmuR1?format=jpg&name=large)

Entire UI of Haven, my real estate mobile app, designed inside Moonchild before a single line of code was written.

# The Problem With How Most Builders Use AI for Design
...
At [@ignytlabs](https://x.com/@ignytlabs) we build a design system for every single client before we touch a screen. This used to take a designer two days. Moonchild does it in about 20 minutes.
...
![Vídeo incrustat](https://pbs.twimg.com/amplify_video_thumb/2057344781358108672/img/7iOnvcVmyO1WHJ8z?format=jpg&name=large)
...
![Imatge](https://pbs.twimg.com/media/HI0omrpbIAAyr0e?format=jpg&name=large)

Moonchild generated the entire Haven UI in one go, including both light and dark mode versions across every screen.

![Imatge](https://pbs.twimg.com/media/HI0o5Z8bgAAP0kh?format=jpg&name=large)
...
![Vídeo incrustat](https://pbs.twimg.com/amplify_video_thumb/2057345875803099136/img/-6H8SF78egrMznFh?format=jpg&name=large)
...
![Vídeo incrustat](https://pbs.twimg.com/amplify_video_thumb/2057346408043450368/img/533OJw_uccHtxx3L?format=jpg&name=large)
...
![Imatge](https://pbs.twimg.com/media/HI0qDtbbcAA-1Tf?format=jpg&name=large)
...
At [@ignytlabs](https://x.com/@ignytlabs) we used to budget two weeks for design across every client MVP. A designer would build the Figma file. A developer would interpret it. The interpretation would drift. We'd correct. Cycle. With this workflow the entire loop collapses into a single afternoon of work. Same quality. Higher margin. Way less context switching.

![Vídeo incrustat](https://pbs.twimg.com/amplify_video_thumb/2057347047968460800/img/QFJrVcpULbHfazhF?format=jpg&name=large)

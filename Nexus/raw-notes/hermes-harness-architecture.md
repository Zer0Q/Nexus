...
created: 2026-05-30
description: "Hermes (from @NousResearch) is one of the best open-source harnesses in the ecosystem right now. We wanted to look at the implementation dir..."
tags:
  - "clippings"
---
![Imatge](https://pbs.twimg.com/media/HJgFznya4AAUddx?format=jpg&name=large)

Hermes (from [@NousResearch](https://x.com/@NousResearch)) is one of the best open-source harnesses in the ecosystem right now. We wanted to look at the implementation directly and map what we found to the framework we use for analyzing harnesses.

In our earlier piece, "[What is an Agent Harness,](https://x.com/aparnadhinak/status/2046980769747533830)" we used a nine-part model:
...
![Imatge](https://pbs.twimg.com/media/HJf_swpbUAMYq0L?format=jpg&name=large)
...
![Imatge](https://pbs.twimg.com/media/HJf0aooa8AAyhft?format=jpg&name=large)
...
![Imatge](https://pbs.twimg.com/media/HJgDelzbEAAp9tO?format=jpg&name=large)
...
![Imatge](https://pbs.twimg.com/media/HJf0o3LbcAAx5ct?format=jpg&name=large)
...
Hermes also exposes a model-facing session\_search tool for focused recall over prior sessions. This is a concrete example of pushing context management decisions into the model loop itself rather than relying only on static injection.
...
![Imatge](https://pbs.twimg.com/media/HJf08mtawAAOvXk?format=jpg&name=large)
...
![Imatge](https://pbs.twimg.com/media/HJf1OQ5bcAAkq_l?format=jpg&name=large)
...
![Imatge](https://pbs.twimg.com/media/HJf-4pdasAAKoU0?format=jpg&name=large)
...
This piece references my previous [What is an Agent Harness,](https://x.com/aparnadhinak/status/2046980769747533830) as framing, and is informed by [Swarm management in agent harnesses](https://arize.com/blog/swarm-management-of-agent-harnesses/), plus Anthropic's posts on [Managed Agents](https://www.anthropic.com/engineering/managed-agents)
...
type: Concept
title: LLM Assessor
description: Modelo LLM procedimentalmente independiente que aplica una rúbrica estandarizada
  para evaluar contribución de texto, usado en métodos como SLICE para estimar...
tags:
- concepts

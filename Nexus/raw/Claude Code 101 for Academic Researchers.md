...
created: 2026-05-31
description: "This is a five-part tutorial to help academic researchers get started on Claude Code. I have written it an accessible language and you don..."
tags:
  - "clippings"
---
![Imatge](https://pbs.twimg.com/media/HHtfCLXXgAEEO6a?format=jpg&name=large)

This is a five-part tutorial to help academic researchers get started on Claude Code. I have written it an accessible language and you don't need any technical background to understand this tutorial or use Claude Code.
...
![Imatge](https://pbs.twimg.com/media/HHtchewW0Ao_IEK?format=jpg&name=large)
...
![Imatge](https://pbs.twimg.com/media/HHtcp2DWwAkC1Bn?format=png&name=large)
...
![Imatge](https://pbs.twimg.com/media/HHtcvN2XoA4pEad?format=png&name=large)
...
![Imatge](https://pbs.twimg.com/media/HHtc_FEWcAckHMA?format=png&name=large)

# Part 2: Installing Claude Code App, Your First Session
...
Claude Code is available for both Windows and Mac. Go to [claude.com/download](https://claude.com/download) and download the version compatible with your computer. Run it the way you would any other installer (e.g. Zoom, Zotero, etc.). On Windows, it appears in your Start Menu. On Mac, it appears in your Applications folder.
...
![Imatge](https://pbs.twimg.com/media/HHtdII5WAAUgPSN?format=png&name=large)
...
![Imatge](https://pbs.twimg.com/media/HHtdL_JXQAcE8M_?format=jpg&name=large)
...
The interaction is like browser-based apps like ChatGPT. The only difference is that now Claude Code has access to your files on your computer. It also has the ability to create files on your computer. Once you are in the folder, give Claude a simple prompt like:
...
![Imatge](https://pbs.twimg.com/media/HHtdQKJWAAEc8_b?format=png&name=large)

# Part 3: Claude Code as Your Research Assistant
...
[#Role](https://x.com/search?q=%23Role&src=hashtag_click) (the hash sign here indicates that it’s a heading) Describe the kind of role you would like Claude Code to assume as your research assistant. Give it a few details about your research field and current project.

[#Standards](https://x.com/search?q=%23Standards&src=hashtag_click) Describe academic standards relevant to your field of research. For example, you can tell Claude Code to follow a given citation style or a specific structure of a research paper.

[#Writing](https://x.com/search?q=%23Writing&src=hashtag_click) Style Tell Claude Code the kind of writing style you would like it to follow, whether you want it to respond in academic style or in an informal style.

[#Critique](https://x.com/search?q=%23Critique&src=hashtag_click) Style Describe how you would like Claude Code to critique your work, whether you would like to focus on your argument, evidence, or methodology.
...
![Imatge](https://pbs.twimg.com/media/HHtdU1aW8A4wAmW?format=png&name=large)
...
![Imatge](https://pbs.twimg.com/media/HHtdZbWXoAE_Ll9?format=png&name=large)
...
![Imatge](https://pbs.twimg.com/media/HHtdeAgXwAQb7D_?format=jpg&name=large)
...
![Imatge](https://pbs.twimg.com/media/HHtdi7WWwAc8BQu?format=png&name=large)
...
![Imatge](https://pbs.twimg.com/media/HHtdv78WQAkcaIa?format=png&name=large)
...
![Imatge](https://pbs.twimg.com/media/HHtd0A0WcAYYKX4?format=png&name=large)
...
![Imatge](https://pbs.twimg.com/media/HHtd4hQWUAAxdr2?format=jpg&name=large)
...
![Imatge](https://pbs.twimg.com/media/HHtd_R3XoAQaqTW?format=png&name=large)

# Part 5: Claude Code “Skills”
...
![Imatge](https://pbs.twimg.com/media/HHteQCUWEAQjwnM?format=png&name=large)
...
![Imatge](https://pbs.twimg.com/media/HHteT8hWoAUlDNb?format=png&name=large)
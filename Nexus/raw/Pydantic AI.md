...
*(This example is complete, it can be run “as is”, assuming you’ve [installed the `pydantic_ai` package](https://pydantic.dev/docs/ai/overview/install))*
...
<iframe src="https://logfire-eu.pydantic.dev/public-trace/a2957caa-b7b7-4883-a529-777742649004?spanId=31aade41ab896144&amp;embedded=true" title="Logfire instrumentation for the bank agent" allow="cross-origin-isolated"></iframe>

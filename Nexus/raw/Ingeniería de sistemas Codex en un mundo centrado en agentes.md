...
![Diagrama titulado “Codex impulsa la app con Chrome DevTools MCP para validar su funcionamiento”. Codex selecciona un objetivo, toma capturas del estado antes y después de activar una ruta de la interfaz de usuario, observa eventos en tiempo de ejecución a través de Chrome DevTools, aplica correcciones, reinicia y entra en un bucle reejecutando la validación hasta que la aplicación esté limpia.](https://images.ctfassets.net/kftzwdyauwt9/2CTNTcnsYAMhiNd1wGzV2g/c4201b91fbb0b92027cee3ce09fff9ed/OAI_Harness_engineering_Codex_drives_the_app_with_Chrome_DevTools_MCP_to_validate_its_work_desktop-dark.png?w=3840&q=80&fm=webp)
...
![Diagrama titulado “Dotar a Codex de una pila completa de observabilidad en el desarrollo local”. Una aplicación envía logs, métricas y trazas a Vector, que distribuye los datos a una pila de observabilidad que contiene Victoria Logs, Metrics y Traces, cada uno consultado mediante las API de LogQL, PromQL o TraceQL. Codex utiliza estas señales para consultar, correlacionar y razonar; luego implementa correcciones en el código base, reinicia la aplicación, vuelve a ejecutar las cargas de trabajo, prueba los recorridos de la interfaz de usuario y repite en un bucle de retroalimentación.](https://images.ctfassets.net/kftzwdyauwt9/1YmCUDeUATM4fvaKq4czT2/bb131b95452dbd6557b9d344d49ad7d2/OAI_Harness_engineering_Giving_Codex_a_full_observability_stack_desktop-dark.png?w=3840&q=80&fm=webp)
...
![Diagrama titulado "Los límites del conocimiento del agente: lo que Codex no puede ver no existe". El conocimiento de Codex se presenta como una burbuja limitada. Debajo hay ejemplos de conocimiento no visible: Google Docs, mensajes de Slack y conocimiento tácito humano. Las flechas indican que, para que esta información sea visible para Codex, debe codificarse en el código base como markdown.](https://images.ctfassets.net/kftzwdyauwt9/BJsaOI7x4AO9jSnUG9r0i/32090f4d14fe0c43f4484d86da21c1e1/OAI_Harness_engineering_The_limits_of_agent_knowledge_desktop-dark.png?w=3840&q=80&fm=webp)

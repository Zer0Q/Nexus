...
## Overview
Map of all thematic indexes in the Nexus vault. Shared entries across indexes show how concepts connect between domains.
...
- **Embeddings** — AI-Vault-Integration, Knowledge-Management, Local-AI, Research-Workflow
- **Smart-Connections-Plugin** — AI-Vault-Integration, Knowledge-Management, Local-AI, Research-Workflow
- **Vault-Context** — AI-Vault-Integration, Knowledge-Management, Research-Workflow
- **RAG** — Knowledge-Management, Local-AI, Research-Workflow
- **Communities-of-Practice** — AI-Governance-and-Risk, Learning-and-Knowledge
- **Tacit-Knowledge** — Knowledge-Management, Learning-and-Knowledge
- **AI-as-Maintainer** — AI-Vault-Integration, Research-Workflow

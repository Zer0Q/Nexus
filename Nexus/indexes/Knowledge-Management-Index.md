...
## Overview
Concepts, frameworks, and tools for building and maintaining personal and organizational knowledge systems.

## Core Concepts
- [[concepts/LLM-Wiki-Pattern]] -- LLM builds/maintains persistent wiki from raw sources
- [[concepts/Write-Time-Knowledge-Systems]] -- compile knowledge at ingest, not query time
- [[concepts/Query-Time-Knowledge-Systems]] -- retrieve from raw docs at query time (RAG)
- [[concepts/Tacit-Knowledge]] -- expert judgment embedded in experience
- [[concepts/Knowledge-Graph-as-Semantic-Layer]] -- structured relationships for AI reasoning
- [[concepts/Codify-without-Flattening]] -- preserve decision context, not just rules
- [[concepts/Knowledge-Mapping]] -- identifying where expertise resides
- [[concepts/Compounding-Knowledge-Context]] -- system value increases non-linearly over time
- [[concepts/Feedback-Loop-Knowledge-System]] -- vault pushes insights, doesn't just store

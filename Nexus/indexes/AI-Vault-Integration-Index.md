...
## Overview
Patterns and tools for connecting AI agents with Obsidian vaults and knowledge bases.

## Core Concepts
- [[concepts/AI-Chief-of-Staff]] -- AI that reads, remembers, briefs automatically
- [[concepts/CLAUDE-MD-as-Context-Layer]] -- personalized AI calibration file
...
- [[concepts/Markdown-as-Universal-Format]] -- .md as bridge between tools
- [[concepts/Federated-Knowledge-Search]] -- search vault + project code in one query
...
- [[tools/BMO-Chatbot]] -- local chat interface
- [[tools/CLAUDE-MD-Project-Knowledge]] -- project context for Claude
